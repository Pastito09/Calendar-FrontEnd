...
describe('Pruebas en calendarSlice', () => { 
    ...
    test('onAddNewEvent debe de agregar el evento', () => { 
        ...
        const newEvent = {
            id: '3',
            start: new Date('2023-11-20 13:00:00'),
            end: new Date('2023-11-20 15:00:00'),
            title: 'Cumpleaños de Ana Maria',
            notes: 'Alguna nota de Ana Maria'
        };
    ...
    test('onUpdateEvent debe de actualizar el evento', () => { 
        ...
        const updatedEvent = {
            ...
            title: 'Cumpleaños de Ana Maria actualizado',
            notes: 'Alguna nota de Ana Maria actualizada'
        };
